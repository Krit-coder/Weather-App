...
const KELVIN = 273;
// API KEY
const key = "7e6452c0f996c4b31dd15d4f53238b21";
...
function getWeather(latitude, longitude){
    ...
    .then( function (data) {
        ...
        weather.date = date.toDateString();
        weather.time = date.toLocaleTimeString();
    })
    .then( function (){
        displayWeather();
    });
...
function displayWeather(){ 
    ...
    windElement.innerHTML = `${weather.wind} <span>km/hr</span>`;
